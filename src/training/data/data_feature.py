...
def main():
    #seq = SequenceFeature(path = '/gpfs/data/tsirigoslab/home/jt3545/hic_prediction/C.Origami/data/hg38/dna_sequence/chr1.fa.gz')
    #ctcf_bw = GenomicFeature.read_feature('/gpfs/data/tsirigoslab/home/jt3545/hic_prediction/C.Origami/data/hg38/imr90/genomic_features/ctcf_chip.bw', 'log')
    #ctcf = GenomicFeature(ctcf_bw)
    hic = HiCFeature(path = '/gpfs/data/tsirigoslab/home/jt3545/hic_prediction/C.Origami/data/hg38/imr90/hic_matrix/chr1.npz')
