...
def main():
    ...
    feature_list = get_feature_list(f'{celltype_root}/genomic_features', genomic_features)

    centrotelo_dict = proc_centrotelo('/gpfs/data/tsirigoslab/home/jt3545/hic_prediction/C.Origami/data/hg38/centrotelo.bed')
    chr_name = 'chr11'
    omit_regions = centrotelo_dict[chr_name]
    dataset = ChromosomeDataset(celltype_root, chr_name, omit_regions, feature_list, use_aug = False)
